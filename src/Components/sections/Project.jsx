    ...
    <section id="projects" className="py-20">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-[#111111] rounded-lg shadow-lg overflow-hidden transition-transform transform">
          ...
          <div className="p-4">
            ...
            <p className="text-gray-300 text-sm mt-2">
              A minimalist blog sharing valuable resources for
              developers—guides, tools, and insights. No clutter, just pure dev
              content. 🚀
            </p>
            <a
              href="https://bichitra-blog.onrender.com/"
              target="_blank"
              className="mt-4 flex items-center text-gray-300 font-semibold"
            >
              🔗 View Website
            </a>
          </div>
        ...
        <div className="bg-[#111111] rounded-lg shadow-lg overflow-hidden transition-transform transform">
          <img
            src={BetterDays}
            alt="BetterDays Project"
            className="w-full h-40 object-cover rounded-t-lg"
          />
          <div className="p-4">
            <h3 className="text-lg font-bold text-[#dedede]">BetterDays</h3>
            <p className="text-gray-300 text-sm mt-2">
              Supporting mental health with self-assessments, valuable
              resources, and guidance to help take charge of your well-being.
            </p>
            <a
              href="https://betterdayshealth.vercel.app/"
              target="_blank"
              className="mt-4 flex items-center text-gray-300 font-semibold"
            >
              🔗 View Website
        ...
        <div className="bg-[#111111] rounded-lg shadow-lg overflow-hidden transition-transform transform">
          ...
          <div className="p-4">
            ...
            <p className="text-gray-300 text-sm mt-2">
              Stay updated with real-time news, important notices, and student
              highlights—all in one place!
            </p>
            <a
              href="https://news-ni7g.onrender.com"
              target="_blank"
              className="mt-4 flex items-center text-gray-300 font-semibold"
            >
              🔗 View Website
        ...
        <div className="bg-[#111111] rounded-lg shadow-lg overflow-hidden transition-transform transform">
          ...
          <div className="p-4">
            ...
            <p className="text-gray-300 text-sm mt-2">
              Enter what you want to see, and we instantly display the perfect
              image for you. No extra steps—just search and view!
            </p>
            <a
              href="https://image-generator-theta-five.vercel.app/"
              target="_blank"
              className="mt-4 flex items-center text-gray-300 font-semibold"
            >
              🔗 View Website
